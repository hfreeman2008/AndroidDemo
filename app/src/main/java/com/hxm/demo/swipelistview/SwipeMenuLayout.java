...
public class SwipeMenuLayout extends FrameLayout {
    ...
    //the view is the index item in listview
    ...
    private int MIN_FLING = Help.dp2px(15,getContext());
    private int MAX_VELOCITYX = -Help.dp2px(500,getContext());
    ...
    private void init() {
        ...
        LayoutParams contentParams = new LayoutParams(LayoutParams.MATCH_PARENT, 120);
    ...
    private void swipe(int dis) {
        ...
        if (mSwipeDirection == SwipeMenuListView.DIRECTION_LEFT) {
            ...
            mMenuView.layout(mContentView.getWidth() - dis,
                    mMenuView.getTop(),
                    mContentView.getWidth() + mMenuView.getWidth() - dis,
                    mMenuView.getBottom());
        } else {
            mMenuView.layout(-mMenuView.getWidth() - dis,
                    mMenuView.getTop(),
                    - dis,
                    mMenuView.getBottom());
        }
